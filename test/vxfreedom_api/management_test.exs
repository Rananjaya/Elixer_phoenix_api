defmodule VxfreedomApi.ManagementTest do
  use VxfreedomApi.DataCase

  alias VxfreedomApi.Management

  describe "projects" do
    alias VxfreedomApi.Management.Project

    @valid_attrs %{escription: "some escription", title: "some title"}
    @update_attrs %{escription: "some updated escription", title: "some updated title"}
    @invalid_attrs %{escription: nil, title: nil}
    ...
    test "create_project/1 with valid data creates a project" do
      ...
      assert project.escription == "some escription"
    ...
    test "update_project/2 with valid data updates the project" do
      ...
      assert project.escription == "some updated escription"
  ...
  describe "documents" do
    alias VxfreedomApi.Management.Document
